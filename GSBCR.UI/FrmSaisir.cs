...
namespace GSBCR.UI
{
    public partial class FrmSaisir : Form
    {
        ...
        //Constructeur pour saisir un nouveau rapport de visite
        public FrmSaisir(RAPPORT_VISITE r, bool maj)
        {
            ...
            //bouton nouveau désactivé tant que l'on n'a pas enregistré
        ...
        private void btnValider_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Abandon traitement suite à erreur lors de la mise à jour : " + ex.Message, "Erreur base de données", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        {
            MEDICAMENT m = Manager.ChargerLeMedicament(r.RAP_MED1); ;
            FrmVoirMedicament f = new FrmVoirMedicament(m);
            f.ShowDialog();
        }

        private void btnVoirMed2_Click(object sender, EventArgs e)
        {
            MEDICAMENT m = Manager.ChargerLeMedicament(r.RAP_MED2); ;
            FrmVoirMedicament f = new FrmVoirMedicament(m);
            f.ShowDialog();
        }
    }
